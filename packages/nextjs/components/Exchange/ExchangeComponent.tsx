...
{!showWalletSelection ? (
                <>
                  ...
                  <p className="text-gray-300 mb-8 text-lg">
                    Click below to see and connect your installed Starknet wallets
                  </p>

                  <div className="space-y-3 mb-6">
                    <button
                      onClick={handleConnectWallet}
                      disabled={!connectors.some(connector => connector.available())}
                ...
                <>
                  <div className="flex items-center mb-6">
                    ...
                    >
                      <svg className="w-6 h-6 text-gray-400 hover:text-green-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-300 mb-8 text-base">
                    Select your preferred Starknet wallet to connect to <span className="font-semibold text-green-400">VOLTA USD</span>
                  </p>

                  <div className="space-y-4 mb-6">
                    {connectors.filter(connector => connector.available()).map((connector) => {
                        ...
                        >
                          ...
                          <div className="flex-1 text-left">
                            ...
                            <div className="text-sm text-gray-400 group-hover:text-gray-300 transition-colors">
                              {connector.name.toLowerCase().includes('argent') && 'Smart wallet for Starknet'}
                              {connector.name.toLowerCase().includes('braavos') && 'Secure multi-sig wallet'}
                              {!connector.name.toLowerCase().includes('argent') && !connector.name.toLowerCase().includes('braavos') && 'Starknet wallet'}
                            </div>
                          </div>
                  ...
                  {connectors.filter(connector => connector.available()).length === 0 && (
                    <div className="text-center py-8">
                      ...
                      <h4 className="text-white font-semibold text-lg mb-2">No Starknet wallets detected</h4>
                      <p className="text-gray-400 mb-6 text-sm max-w-sm mx-auto">
                        Please install a Starknet wallet to connect and start trading
                      </p>
