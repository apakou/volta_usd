...
fn deploy_security_test_system() -> (ContractAddress, ContractAddress, ContractAddress, ContractAddress) {
...
fn test_pause_functionality_owner_can_pause() {
    let (vault_address, _vusd_address, _wbtc_address, _oracle_address) = deploy_security_test_system();
    let owner_address = contract_address_const::<OWNER>();
...
fn test_pause_functionality_deposit_fails_when_paused() {
    let (vault_address, _vusd_address, wbtc_address, _oracle_address) = deploy_security_test_system();
    let owner_address = contract_address_const::<OWNER>();
...
fn test_pause_functionality_withdrawal_fails_when_paused() {
    let (vault_address, vusd_address, wbtc_address, _oracle_address) = deploy_security_test_system();
    let owner_address = contract_address_const::<OWNER>();
    let user_address = contract_address_const::<USER>();
...
fn test_pause_functionality_view_functions_work_when_paused() {
    ...
    assert!(user_collateral_after == user_collateral_before, "User collateral should be accessible when paused");
    assert!(collateral_ratio_after == collateral_ratio_before, "Collateral ratio should be accessible when paused");
